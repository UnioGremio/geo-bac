...
(function(){
  ...
  // URL public direct (bucketul e public, protectia e in auth.js)
  function getSignedUrl(token, filename, cb){
    cb(SUPABASE_URL + '/storage/v1/object/public/' + BUCKET + '/' + filename);
  }nction getSignedUrl(token, filename, cb){
    var xhr = new XMLHttpRequest();

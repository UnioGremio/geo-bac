(function(){
  ...
  // Doar paginile CU PLATĂ
  var PROTECTED = ['europa','romania','vecini','exercitii-harta','subiecte'];
  ...
  function proceed(){
    ...
    checkPremium(token, function(isPremium){
      ...
      document.cookie = 'sb-access-token=' + encodeURIComponent(token) + ';path=/;max-age=3600;SameSite=Strict';

...
(function(){
  ...
  var PROTECTED = ['europa.html','romania.html','vecini.html','subiecte.html','exercitii.html','subiecte-ani-precedenti.html','exercitii-harta.html'];
  ...
  function getSignedUrl(token, filename, cb){
    ...
    xhr.onload = function(){
      try {
        ...
        if(d.signedURL){
          // signedURL e relativ — construim URL-ul complet
          cb(SUPABASE_URL + d.signedURL);
        } else {
          cb(null);
        }
      } catch(e){ cb(null); }

(function(){
  if(location.pathname.includes('/protected/')) return;
  ...
  var PROTECTED = ['europa','romania','vecini','exercitii','exercitii-harta','subiecte','subiecte-ani-precedenti'];
  ...
  function proceed(){
    ...
    checkPremium(token, function(isPremium){
      ...
      document.cookie = 'sb-access-token=' + encodeURIComponent(token) + ';path=/;max-age=300;SameSite=Strict';
